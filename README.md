...
- `netlify/functions/llm-suggest.js` → sugerencias de categorización con LLM (requiere ANTHROPIC_API_KEY propia — sin key configurada, no rompe la app, solo no sugiere)
